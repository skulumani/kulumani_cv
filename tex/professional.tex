...
\begin{itemize}
\item[] \textit{Spacecraft Guidance and Control Analyst\\Space Exploration Sector~(SES/SAC)}
                \hfill {May~2022-Present}
    \begin{itemize}
        \item Performing Guidance and Control analysis for Parker Solar Probe. 
            Planning spacecraft attitude manuevers for communication, planetary flybys, and trajectory change manuevers.
            Analyzing system performance in the face of disturbance torques to meet system and scientific objectives.
        \item Supporting Interstellar Mapping and Acceleration Probe (IMAP) development.
            Performing analysis of vibrational motion of flexible body effects due to input disturbance forces.
    \end{itemize}

    \item [] \textit{Guidance, Navigation, and Control Engineer\\Force Protection Sector~(FPS/KFI)} \hfill {June~2021-May~2022}
        \begin{itemize}
            \item Developed nonlinear state estimation and sensor fusion algorithms to support post test flight accuracy for the Ground Based Strategic Deterence (GBSD) program.
            \item Performed covariance analysis and simulation framework development for alternative navigation solutions in GPS denied areas for the Conventional Prompt Strike (CPS) program.
            \item Developed computational tools to process and verify metric tracking data from radar and optical sensors at Kwajaelin Atoll.
            \item Created inertial navigation software to fuse aiding measurements with onboard inertial accelerometer and gyro data to enable state estimation for ballistic missile reentry bodies.
        \end{itemize}
\end{itemize}
