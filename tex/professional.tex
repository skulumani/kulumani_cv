...
\begin{itemize}
    \item[] \textit{Senior Principal Astrodynamics Engineer} \hfill {Jan~2021-Present}
        \begin{itemize}
            \item Developing astrodynamics software in C++ and Python supporting next generation space systems. 
        \end{itemize}
\end{itemize}
\textbf{Collins Aerospace}

\begin{itemize}
    \item[] \textit{Senior Systems Engineer, Flight Control and Navigation}
