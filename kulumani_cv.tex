...
\item[] \textit{Lead Test Engineer, Guidance, Navigation, \& Control Group \\
    ...
    \begin{innerlist}
        ...
        An Unscented Kalman Filter~(UKF) was developed to verify and validated the performance of a GPS receiver in geostationary orbit.
		...
		Incorporated the effects of solar radiation pressure, attitude control system, Earth gravitational models, and thruster uncertainties to predict the expected performance of the spacecraft.
...
\begin{innerlist}
	\item {Most Innovative/Creative Project Award, 
	5th Annual Student Competition Society of Satellite Professionals International~(SSPI) \\
	Systematic design of optimal low-thrust orbital transfers in the three-body problem} \hfill {2015}  
	\item Graduate Research Fellowship, George Washington University \hfill {2014}
\end{innerlist}
