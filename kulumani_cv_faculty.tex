...
\item[] M.S.,
        \href{https://engineering.purdue.edu/AAE}
             ...
             December 2013
        \begin{innerlist}
        \item Non-thesis option
        \item Area of Study: Dynamics and Control Engineering
        \end{innerlist}
...
\begin{bibenum}
    ...
    \item Pavlic, T.P. Stochastic strategies for modeling
        self\-/organization in complex systems of social insects. In:
...
\begin{bibenum}
    \item Pavlic, T.P., S.~Wilson, G.P.~Kumar, and S.~Berman. An
        enzyme-inspired approach to stochastic allocation of robotic
        swarms with application to team formation around circular
        boundaries.

    \item Pavlic, T.P. Constrained optimization as unifying framework
        for the ideal free distribution and the marginal value theorem.
\end{bibenum}
...
\begin{bibsection}
    ...
    \item Co\-/PI,
        ...
        NIFA\-/AFRI Foundational proposal, 2013. Submitted.
