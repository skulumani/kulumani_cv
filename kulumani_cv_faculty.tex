...
\item[] \textit{Lead Test Engineer, Air Force Research Laboratory}%
    ...
    \begin{innerlist}
        \item 
        \item Lead attitude dynamics research for CMG test-bed known as Attitude Control System Proving ground
...
%
\begin{innerlist}
    \item Astrodynamics, Orbit Determination, Rocket Propulsion,  
\end{innerlist}
